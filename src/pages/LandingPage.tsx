...
import { Users, Users2, BarChart3, BookOpen } from 'lucide-react';
            ...
            <header className="bg-white/80 backdrop-blur-sm sticky top-0 z-50 border-b border-slate-100">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 py-5 flex justify-between items-center">
                    ...
                    <div className="flex items-center space-x-4">
                        <button
                            onClick={() => navigate('/bible-studies-public')}
                            className="flex items-center space-x-2 text-slate-600 font-medium hover:text-[#2c7a8c] transition-colors"
                        >
                            <BookOpen size={18} />
                            <span className="hidden sm:inline">Estudios Bíblicos</span>
                        </button>
                        <button
