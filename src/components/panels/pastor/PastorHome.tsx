...
import { Church as ChurchIcon, UserCog, PlusCircle, Edit, FileText, TrendingUp, AlertTriangle, BarChart, BookOpen, PlusSquare, UserPlus, Zap, Globe, Activity } from 'lucide-react';
    ...
    return (
        <div className="space-y-6">
            ...
            <section className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                ...
                <MenuButton icon={<PlusSquare size={32} />} label="Crear Iglesia" onClick={() => navigate('create-church')} />
                <MenuButton icon={<UserPlus size={32} />} label="Crear GP" onClick={() => navigate('create-group')} />
                <MenuButton icon={<Edit size={32} />} label="Editar GP" onClick={() => navigate('edit-group')} />
                ...
                <MenuButton icon={<Zap size={32} />} label="Reportes Auto" onClick={() => navigate('auto-reports')} />
                <MenuButton icon={<Globe size={32} />} label="Reportes Globales" onClick={() => navigate('global-reports')} />
                <MenuButton icon={<BookOpen size={32} />} label="Estudios Bíblicos" onClick={() => navigate('bible-studies')} />
                <MenuButton icon={<Activity size={32} />} label="Análisis General" onClick={() => navigate('analysis')} />
            </section>
        </div>
    );
};
