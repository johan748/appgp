...
import { Calendar, Target, Users, Heart, ClipboardList, UserPlus, UserCheck, Award, BookOpen } from 'lucide-react';
    ...
    return (
        <div className="space-y-6">
            ...
            <section className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                ...
                <MenuButton icon={<BookOpen size={28} />} label="Estudios Bíblicos" onClick={() => navigate('bible-studies')} />
            </section>
        </div>
    );
};
