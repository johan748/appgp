...
export interface IBackendService {
    ...
    createUser(userData: Omit<User, 'id'> & { id?: string }): Promise<User>;
    ...
    getStudentsByGP(gpId: string): Promise<Student[]>;
    addStudent(student: Student): Promise<Student>;
    updateStudent(student: Student): Promise<void>;
    deleteStudent(id: string): Promise<void>;
    getLessons(): Promise<BibleStudyLesson[]>;
    saveLesson(lesson: BibleStudyLesson): Promise<BibleStudyLesson>;
