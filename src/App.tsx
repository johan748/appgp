...
import PublicBibleStudiesPage from './pages/PublicBibleStudiesPage';
...
import BibleStudiesView from './components/panels/leader/BibleStudiesView';
...
import PastorGeneralAnalysisView from './components/panels/pastor/PastorGeneralAnalysisView';
...
const ProtectedRoute: React.FC<{ children: React.ReactNode; allowedRoles?: string[] }> = ({ children, allowedRoles }) => {
    ...
    if (isLoading) {
        return <div className="min-h-screen flex items-center justify-center">
            <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#3e8391]"></div>
        </div>;
    }
                    ...
                    <Router>
                        <Routes>
                            ...
                            <Route path="/leader" element={
                                ...
                                <Route path="bible-studies" element={<BibleStudiesView />} />
                            </Route>
                            ...
                            <Route path="/pastor" element={
                                ...
                                <Route path="analysis" element={<PastorGeneralAnalysisView />} />
                                <Route path="bible-studies" element={<BibleStudiesView />} />
                            ...
                            {/* Default Redirect */}
                            <Route path="/bible-studies-public" element={<PublicBibleStudiesPage />} />
